...
package com.hzf.widget.roundedimageview;

import static com.hzf.widget.roundedimageview.RoundedDrawable.CORNER_BOTTOM_LEFT;
import static com.hzf.widget.roundedimageview.RoundedDrawable.CORNER_BOTTOM_RIGHT;
import static com.hzf.widget.roundedimageview.RoundedDrawable.CORNER_TOP_LEFT;
import static com.hzf.widget.roundedimageview.RoundedDrawable.CORNER_TOP_RIGHT;
...
public final class RoundedTransformationBuilder {
	...
	public Transformation<Bitmap> build() {
		return new Transformation<Bitmap>() {

			@Override
			public Resource<Bitmap> transform(Resource<Bitmap> arg0, int arg1,
					int arg2) {
				// TODO Auto-generated method stub
				final Bitmap transformed = RoundedDrawable
						.fromBitmap(arg0.get())
				...
				if (!arg0.get().equals(transformed)) {
					arg0.get().recycle();
				}
